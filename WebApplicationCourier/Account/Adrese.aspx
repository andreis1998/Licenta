<%@ Page Title="Adrese" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Adrese.aspx.cs" Inherits="WebApplicationCourier.Account.Adrese" %>
    ...
    <h2><%: Title %></h2><br><br>
         <div class="row">
             <div class="col-md-8">
                ...
                <%--<div class="col-md-10">
                    <asp:Button runat="server" CssClass="btn btn-default" Text="Cauta adresa" Width="245px"/>
                </div><br>--%>
             </div>
        </div>
    <asp:Button runat="server" CssClass="btn btn-default" Text="<--" OnClick="Back_Click"/>
